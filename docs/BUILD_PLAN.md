...
- [x] npm workspaces for platform, NovaMart, and shared contracts
- [x] strict TypeScript, Tailwind, ESLint, Vitest, and root scripts
- [x] temporary homepages on ports 3000 and 3001
- [x] local storage directories and environment template
- [x] Prisma/SQLite model, relationships, indexes, and service layer
- [x] shared Zod schemas and TypeScript types
- [x] migration, seed, and reset commands
...
- [x] Real controlled Chromium scan of `https://example.com/`
- [x] Persisted screenshot, page metadata, two real axe findings and 90/100 transparent score
- [x] External findings provide rule-specific implementation and validation guidance
- [x] Source mapping and repair remain unavailable for external audit projects
